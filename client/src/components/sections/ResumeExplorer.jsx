  ...
  return (
    <section className="section resume-section" id="templates" aria-labelledby="resume-title">
      <div className="section-heading">
        ...
        <h2 id="resume-title"><span className="heading-glass-text">Pick a template, then let AI tune it for the job.</span></h2>
      </div>
        ...
        {resumeTemplates.map((template) => (
          <article className="resume-card" key={template.id}>
            <div className="resume-card__inner">
              ...
              <h3><span className="heading-glass-text">{template.title}</span></h3>
              <p>{template.role}</p>
